...
README.md is the source. README.ko.md, README.zh-CN.md and README.ja.md
translate it one line at a time: line N of a translation is line N of the
English file in another language. That makes drift easy to see. A paper added
...
TITLES = {
    "✨ Highlights": {"ko": "✨ 한눈에 보기", "zh": "✨ 亮点", "ja": "✨ ハイライト"},
    "⭐ Starter Kit": {"ko": "⭐ 스타터 키트", "zh": "⭐ 入门必读", "ja": "⭐ スターターキット"},
    "🔥 10 to Watch (2026)": {"ko": "🔥 주목할 10편 (2026)", "zh": "🔥 值得关注的 10 篇 (2026)", "ja": "🔥 注目の10本 (2026)"},
    "Contents": {"ko": '<a id="contents"></a>목차', "zh": '<a id="contents"></a>目录', "ja": '<a id="contents"></a>目次'},
    "🧭 Background": {"ko": "🧭 배경", "zh": "🧭 背景", "ja": "🧭 背景"},
    "📚 Surveys & Position Papers": {"ko": "📚 서베이와 포지션 페이퍼", "zh": "📚 综述与立场论文", "ja": "📚 サーベイとポジションペーパー"},
    "🏗️ Agent Architectures & Frameworks": {"ko": "🏗️ 에이전트 아키텍처와 프레임워크", "zh": "🏗️ 智能体架构与框架", "ja": "🏗️ エージェントのアーキテクチャとフレームワーク"},
    "🧱 Part I: Core Components": {"ko": "🧱 제1부: 핵심 구성 요소", "zh": "🧱 第一部分：核心组成", "ja": "🧱 第1部：中核となる構成要素"},
    "🧠 Planning & Reasoning": {"ko": "🧠 계획과 추론", "zh": "🧠 规划与推理", "ja": "🧠 計画と推論"},
    "💾 Memory": {"ko": "💾 메모리", "zh": "💾 记忆", "ja": "💾 メモリ"},
    "🔧 Tool Use": {"ko": "🔧 도구 사용", "zh": "🔧 工具使用", "ja": "🔧 ツール利用"},
    "🤝 Multi-Agent Systems": {"ko": "🤝 다중 에이전트 시스템", "zh": "🤝 多智能体系统", "ja": "🤝 マルチエージェントシステム"},
    "🌍 Part II: Agents in Context": {"ko": "🌍 제2부: 환경과 응용 속의 에이전트", "zh": "🌍 第二部分：环境与应用中的智能体", "ja": "🌍 第2部：環境と応用のなかのエージェント"},
    "🌐 Interactive Environments": {"ko": "🌐 상호작용 환경", "zh": "🌐 交互环境", "ja": "🌐 インタラクティブ環境"},
    "🚀 Applications": {"ko": "🚀 응용 분야", "zh": "🚀 应用领域", "ja": "🚀 応用分野"},
    "⚖️ Part III: Cross-Cutting Concerns": {"ko": "⚖️ 제3부: 전반에 걸친 과제", "zh": "⚖️ 第三部分：贯穿全局的问题", "ja": "⚖️ 第3部：横断的な課題"},
    "📊 Evaluation & Benchmarks": {"ko": "📊 평가와 벤치마크", "zh": "📊 评估与基准", "ja": "📊 評価とベンチマーク"},
    "🛡️ Safety & Alignment": {"ko": "🛡️ 안전과 정렬", "zh": "🛡️ 安全与对齐", "ja": "🛡️ 安全性とアライメント"},
    "🔗 Related Awesome Lists": {"ko": "🔗 관련 Awesome 리스트", "zh": "🔗 相关 Awesome 列表", "ja": "🔗 関連するAwesomeリスト"},
    "📄 Citation": {"ko": "📄 인용", "zh": "📄 引用", "ja": "📄 引用"},
    "🤝 Contributing": {"ko": "🤝 기여하기", "zh": "🤝 参与贡献", "ja": "🤝 コントリビュート"},
    "👥 Contributors": {"ko": "👥 기여자", "zh": "👥 贡献者", "ja": "👥 コントリビューター"},
    "📜 License": {"ko": "📜 라이선스", "zh": "📜 许可证", "ja": "📜 ライセンス"},
    "🗓️ Updates": {"ko": "🗓️ 업데이트 기록", "zh": "🗓️ 更新记录", "ja": "🗓️ 更新履歴"},
}
...
# edition bolds itself and links the other three.
...
def check_pair(src: list[str], tr: list[str], lang: str, forbidden) -> tuple[list[str], list[str]]:
    ...
    for i, (en, t) in enumerate(zip(src, tr), 1):
        ...
        for en_term, bad in forbidden[lang]:
            ...
            if re.search(re.escape(bad) + (r"(?!\d)" if bad[-1].isdigit() else ""), t):
        ...
        if not fixed_line:
            n_en, n_tr = Counter(NUM.findall(en)), Counter(NUM.findall(t))
            if n_en != n_tr:
